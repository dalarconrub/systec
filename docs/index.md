...
- **Hora** - cuándo debe ejecutarse
- **Recurrencia** - con qué frecuencia se repite
- **Fecha de inicio** - cuándo comienza
- **Fecha límite (deadline)** - cuándo debe completarse
...
Explora los conceptos fundamentales, filosofía y casos de uso del sistema.
